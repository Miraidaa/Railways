...
Minimum requirements (8 points)
  ...
  - [x] Menu: The main menu displays the necessary elements: a name input field, a difficulty selection option, and a start button (1 point) - done
  - [x] Menu: Clicking the Start button takes us to the game screen. (1 point) - done
  - [x] Menu: The game rules can be accessed from the menu. (1 point) - done
  - [x] Game screen: The player's name is displayed on the game screen, and the timer starts (1 point) - done
